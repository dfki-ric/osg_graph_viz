...
namespace osg_graph_viz {
  ...
  void View::exportLabelToSvg(osg::ref_ptr<osg_text::Text> label,
    ...
    double fz = label->getFontsize()*0.85;
    ...
    fprintf(f, "    <text xml:space=\"preserve\" style=\"font-style:normal;font-weight:%s;font-size:10px;line-height:125%%;font-family:Stilu;letter-spacing:0px;word-spacing:0px;fill:#000000;fill-opacity:1;stroke:none;stroke-width:1px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1;text-align:%s;text-anchor:%s\" x=\"%g\" y=\"%g\" id=\"label_%lu\">\n", weight.c_str(), a1.c_str(), a2.c_str(), x2, y2, labelID);
    x2 = ol+r+10;
    if(align == osg_text::ALIGN_LEFT) {
      x2 = ol+l+pr;
    }
    ...
    text = mars::utils::replaceString(text, "<", "&lt;");
    text = mars::utils::replaceString(text, ">", "&gt;");
